...
class AuthRateLimit(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("octet_length(subject_hash) = 32", name="auth_rate_limit_subject_hash_length"),
        CheckConstraint("dimension IN ('employee','device','network')", name="auth_rate_limit_dimension"),
...
class AuditEvent(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("device_id_hash IS NULL OR octet_length(device_id_hash) = 32", name="audit_event_device_hash_length"),
        CheckConstraint("network_hash IS NULL OR octet_length(network_hash) = 32", name="audit_event_network_hash_length"),
