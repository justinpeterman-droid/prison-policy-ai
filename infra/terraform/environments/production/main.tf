module "access_platform" {
  ...
  enable_logical_export_scheduler             = var.enable_logical_export_scheduler
  logical_export_polling_authorization_record = var.logical_export_polling_authorization_record
  ...
  sql_export_service_account_email            = var.sql_export_service_account_email
