module "access_platform" {
  ...
  enable_logical_export_scheduler             = false
  logical_export_polling_authorization_record = ""
  ...
  sql_export_service_account_email            = "fixture-cloudsql-export@${var.project_id}.iam.gserviceaccount.com"
