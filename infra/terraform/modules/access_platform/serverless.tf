  ...
  template {
    ...
    containers {
      ...
      env {
        ...
        value = google_service_account.identities["task_invoker"].email
      }
      env {
        name  = "SOURCE_COMMIT"
      ...
      env {
        ...
        value_source {
          secret_key_ref {
            secret  = google_secret_manager_secret.containers["identity-hash-pepper"].secret_id
            version = "latest"
          }
        }
      }
      env {
        ...
        value_source {
          secret_key_ref {
            secret  = google_secret_manager_secret.containers["cursor-signing-key"].secret_id
            version = "latest"
          }
        }
      }
      env {
        ...
        value_source {
          secret_key_ref {
            secret  = google_secret_manager_secret.containers["client-update-grant-key"].secret_id
            version = "latest"
          }
        }
      }
      env {
        ...
        value_source {
          secret_key_ref {
            secret  = google_secret_manager_secret.containers["legacy-access-code"].secret_id
            version = "latest"
          }
        }
      }
      env {
        ...
        value_source {
          secret_key_ref {
            secret  = google_secret_manager_secret.containers["legacy-admin-code"].secret_id
            version = "latest"
          }
        }
      }
      env {
        ...
        value_source {
          secret_key_ref {
            secret  = google_secret_manager_secret.containers["github-feedback-token"].secret_id
            version = "latest"
          }
        }
      }
