...
def test_subject_hash_is_dimension_and_value_specific():
    pepper = "p" * 32
    assert subject_hash("employee", "EMP-1001", pepper) != subject_hash("employee", "EMP-1002", pepper)
    assert subject_hash("employee", "EMP-1001", pepper) != subject_hash("device", "EMP-1001", pepper)
