"""Required CI contract for the remaining Guided Operations Incident Workspace."""
...
def test_openapi_exposes_complete_cookie_authenticated_incident_workspace():
    document = yaml.safe_load(Path("openapi/web-v1.yaml").read_text(encoding="utf-8"))
